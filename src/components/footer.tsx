...
export default function Footer() {
  ...
  return (
    <footer className="bg-texto text-papel/60">
      <div className="border-b border-papel/10">
        <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="font-display text-xl text-papel tracking-tight">{nombre}</p>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] text-papel/50 hover:text-papel transition-colors focus:outline-none focus-visible:text-papel focus-visible:ring-2 focus-visible:ring-mostaza focus-visible:ring-offset-2 focus-visible:ring-offset-texto"
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row items-center justify-between gap-3">
        <p className="font-serif text-xs text-papel/40 text-center">
          {ubicacion.direccion}, {ubicacion.localidad} &middot; {ubicacion.provincia}
        </p>
        <p className="font-serif text-xs text-papel/30">
