  ...
  return (
    <section id="contacto" className="relative py-12 md:py-20 px-4 bg-papel overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative">
        ...
        <div className="w-16 h-0.5 bg-mostaza mx-auto mb-10" />

        <a
          href={`https://wa.me/${negocio.contacto.telefonoLink}`}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-3 bg-mostaza hover:bg-mostaza-claro text-texto font-display text-lg tracking-wider min-h-[56px] px-10 py-3 rounded-sm transition-all duration-300 shadow-lg hover:shadow-xl mb-10 focus:outline-none focus-visible:ring-2 focus-visible:ring-mostaza focus-visible:ring-offset-2 focus-visible:ring-offset-papel"
        >
